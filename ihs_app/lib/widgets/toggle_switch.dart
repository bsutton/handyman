      ...
      child: Container(
        ...
        child: Row(
          ...
          children: List.generate(widget.labels.length * 2 - 1, (index) {
            ...
            if (active) {
              bgColor = widget.activeColors == null ? widget.activeBgColor : widget.activeColors[index ~/ 2];
            }
            if (index % 2 == 1) {
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  child: widget.icons == null
                      ? Text(widget.labels[index ~/ 2], style: TextStyle(color: textColor))
                      : Row(
                          children: <Widget>[
                            Icon(widget.icons[index ~/ 2], color: textColor, size: 17.0),
                            Padding(
