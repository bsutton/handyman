...
/// is slow to build. It will display a [BlockingUIWidget]
...
/// The [BlockingUIWidget] should NOT be used directly.
///
/// It is added to [AppScaffold] as an overlay and is
...
class BlockingUIWidget extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => BlockingUIWidgetState();
  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
...
///
class BlockingUIWidgetState extends State<BlockingUIWidget> {
  @override
