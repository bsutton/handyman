...
class AMPMButton extends StatelessWidget {
  AMPMButton({required this.label, super.key})
      : am = label.toLowerCase() == 'am';
  final String label;
  final bool am;
  ...
  VoidCallback? onPressed(BuildContext context) {
    Provider.of<LocalTimeState>(context, listen: false).setAMPM(am: am);
    return null;
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty<bool>('am', am));
  }
}
